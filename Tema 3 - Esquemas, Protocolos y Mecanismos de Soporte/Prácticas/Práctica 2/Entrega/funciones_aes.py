...
def cifrarAES_GCM(aes_cifrado, datos):
    """Cifra el parametro datos_AT (de tipo array de bytes), y devuelve el texto cifrado binario Y el mac Y el nonce """
...
def cifrarAES_CTR(aes_cifrado, datos):
    """Cifra el parametro datos_AT (de tipo array de bytes), y devuelve el texto cifrado binario Y el mac"""
    # En escenarios reales, el objeto AES se inicializa una vez, y luego vamos llamando a aes_cifrado
...
def descifrarAES_CTR(key_16, nonce_16, datos):
    """Descifra el parametro datos_AT (de tipo binario), y devuelve los datos_AT descrifrados de tipo array de bytes"""
