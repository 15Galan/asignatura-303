...
class SOCKET_SIMPLE_TCP:
    ...
    def __recvall(self, count):
        ...
        while count:
            # Puede que no reciba "count", asi que tengo que leer hasta recibirlo completamente
    ...
    def enviar(self, datos):
        """Envia un array de bytes "datos_AT" del origen al destino."""
        longitud = len(datos)
    ...
    def recibir(self):
        """Recibe un array de bytes "datos_AT" del destino al destino."""
